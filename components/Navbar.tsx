...
const courses = [
  {
    ...
    icon: '🩺',
    links: [
      { name: 'Class 11 + 12 NEET', href: '/courses/neet-11' },
      { name: 'Repeater NEET', href: '/courses/neet-dropper' },
  ...
  },
  {
    ...
    icon: '⚙️',
    links: [
      { name: 'Class 11 + 12 JEE', href: '/courses/jee-11' },
      { name: 'Repeater JEE', href: '/courses/jee-dropper' },
  ...
  },
  {
    ...
    icon: '📘',
    links: [
      { name: 'Class 11 + 12 CET', href: '/courses/mht-cet-11' },
      { name: 'Repeater CET', href: '/courses/mht-cet-dropper' },
