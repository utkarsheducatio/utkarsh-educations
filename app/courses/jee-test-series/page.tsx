...
export default function JEETestSeriesPage() {
  ...
  const features = [
    { icon: '📝', title: 'Full-Length Tests', description: '100+ complete JEE mock tests in official pattern' },
    { icon: '📊', title: 'Detailed Analysis', description: 'Comprehensive performance breakdown for each test' },
    { icon: '⚡', title: 'Instant Solutions', description: 'Step-by-step solutions with multiple approaches' },
    { icon: '📈', title: 'Progress Tracking', description: 'Track improvement with detailed analytics' },
    { icon: '🎯', title: 'Topic-wise Tests', description: '200+ chapter-based and topic tests' },
    { icon: '💻', title: 'Online Platform', description: 'Access tests anytime from anywhere' },
  ];

  const testCategories = [
    {
      title: 'JEE Mains Tests',
      tests: '75+ full-length mock exams',
  ...
  const advantages = [
    { title: 'Real Exam Pattern', description: 'Tests follow official JEE pattern & difficulty level' },
          ...
          >
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                Master JEE with our comprehensive test series. 315+ full-length and topic-wise tests with detailed solutions and performance analytics for both JEE Mains and Advanced.
              </p>

              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                  <span className="text-lg">315+ Tests (Mains + Advanced)</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                  <span className="text-lg">Real JEE Exam Pattern</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
              ...
              <div className="bg-gradient-to-br from-blue-400 to-purple-400 rounded-2xl p-8 backdrop-blur-sm border border-white/20 shadow-2xl">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/20 rounded-lg p-4">
                    ...
                    <p className="text-white/90">315+ comprehensive tests</p>
                  </div>
                  <div className="bg-white/20 rounded-lg p-4">
      ...
      <section className="py-16 bg-gray-50" id="details">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">Everything you need to crack JEE</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {advantages.map((adv, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                whileHover={{ y: -10 }}
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-l-4 border-blue-500"
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { label: 'JEE Mains Tests', value: '75+', icon: '📋' },
              { label: 'JEE Advanced Tests', value: '40+', icon: '🚀' },
              { label: 'Topic Tests', value: '200+', icon: '🎯' },
              { label: 'Total Questions', value: '10000+', icon: '❓' },
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl p-6 text-white text-center shadow-lg"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              📝 Master JEE with Practice
            </h2>
            <p className="text-xl text-white/90 mb-8">
              Join thousands of students who have improved their scores with our test series. Start practicing with real exam patterns today and ace JEE!
            </p>
