          ...
          >
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                Comprehensive JEE (Main + Advanced) coaching with expert faculty, proven curriculum, and consistent track record of IIT selections.
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-400 to-purple-400 rounded-2xl p-8 backdrop-blur-sm border border-white/20 shadow-2xl">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/20 rounded-lg p-4">
                    ...
                    <p className="text-white/90">2 Years (Class 11th & 12th)</p>
                  </div>
                  <div className="bg-white/20 rounded-lg p-4">
