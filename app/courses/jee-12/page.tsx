...
export default function JEEClass12Page() {
  ...
  const features = [
    { icon: '👨‍🏫', title: 'Advanced IIT Faculty', description: 'Learn from IIT alumni with years of teaching experience' },
    { icon: '📚', title: 'JEE Advanced Focused', description: 'Specialized curriculum for JEE Advanced preparation' },
    { icon: '🎯', title: '100+ Mock Tests', description: 'JEE Mains pattern + JEE Advanced level tests' },
    { icon: '💡', title: 'Intensive Doubt Sessions', description: 'Daily doubt clearing with expert instructors' },
    { icon: '📊', title: 'Detailed Analysis', description: 'Topic-wise and chapter-wise performance reports' },
    { icon: '🏆', title: 'Success Blueprint', description: 'Strategies and techniques from top IIT rankers' },
  ];
  ...
  const courseModules = [
    {
      subject: 'Physics',
      icon: '⚛️',
      topics: ['Advanced Mechanics', 'Thermodynamics & Waves', 'Electromagnetism', 'Modern Physics', 'Nuclear Physics', 'Experiments'],
      color: 'from-blue-500 to-cyan-500'
    },
    {
      subject: 'Chemistry',
      icon: '🧪',
      topics: ['Physical Chemistry', 'Organic Chemistry', 'Inorganic Chemistry', 'Qualitative Analysis', 'Practical Chemistry', 'Advanced Reactions'],
      color: 'from-purple-500 to-pink-500'
    },
    {
      subject: 'Mathematics',
      icon: '📐',
      topics: ['Advanced Algebra', 'Calculus', 'Vector 3D', 'Coordinate Geometry', 'Differential Equations', 'Complex Numbers'],
          ...
          >
            <div>
              <div className="inline-block bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                <span className="text-white font-semibold">JEE Advanced Prep</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                Ace JEE Advanced
              </h1>
              <p className="text-xl text-white/90 mb-8">
                Intensive preparation for JEE Advanced with focus on complex problem-solving and high-level conceptual understanding.
              </p>

              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                  <span className="text-lg">Advanced Problem Solving</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                  <span className="text-lg">Intensive Mentoring</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-400 to-purple-400 rounded-2xl p-8 backdrop-blur-sm border border-white/20 shadow-2xl">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/20 rounded-lg p-4">
                    ...
                    <p className="text-white/90">₹1,35,000 per year</p>
                  </div>
                  <div className="bg-white/20 rounded-lg p-4">
                    <p className="font-semibold mb-2">✨ Highlights</p>
                    <p className="text-white/90">Advanced curriculum with intensive tests</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 bg-gray-50" id="details">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">Designed for JEE Advanced excellence</p>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">Comprehensive and depth-focused preparation</p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              📝 Enroll in JEE Advanced Batch
            </h2>
            <p className="text-xl text-white/90 mb-8">
              Start your advanced JEE preparation with expert faculty and proven success strategies.
            </p>
