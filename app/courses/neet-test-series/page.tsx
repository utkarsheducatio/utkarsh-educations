...
export default function NEETTestSeriesPage() {
  ...
  const features = [
    { icon: '📝', title: 'Full-Length Tests', description: '50+ complete NEET mock tests in official pattern' },
    ...
    { icon: '🎯', title: 'Topic-wise Tests', description: '150+ chapter-based and topic tests' },
  ...
  const advantages = [
    { title: 'Real Exam Pattern', description: 'Tests follow official NEET pattern & difficulty level' },
          ...
          >
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                Master NEET with our comprehensive test series. 250+ full-length and topic-wise tests with detailed solutions and performance analytics.
              </p>

              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                  <span className="text-lg">250+ Tests (Full-Length + Topic-Wise)</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
                  <span className="text-lg">Real NEET Exam Pattern & Difficulty</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">✓</span>
              ...
              <div className="bg-gradient-to-br from-pink-400 to-rose-400 rounded-2xl p-8 backdrop-blur-sm border border-white/20 shadow-2xl">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/20 rounded-lg p-4">
                    ...
                    <p className="text-white/90">250+ comprehensive tests</p>
                  </div>
                  <div className="bg-white/20 rounded-lg p-4">
      ...
      <section className="py-16 bg-gray-50" id="details">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">Everything you need to crack NEET</p>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { label: 'Full-Length Tests', value: '50+', icon: '📋' },
              { label: 'Topic Tests', value: '150+', icon: '🎯' },
              { label: 'Previous Year Papers', value: '15+', icon: '📄' },
              { label: 'Total Questions', value: '7500+', icon: '❓' },
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
